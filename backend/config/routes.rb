Rails.application.routes.draw do
  ...
  get "api-docs", to: "documentation#index", as: :api_docs
  get "api-docs/openapi.yaml", to: "documentation#spec", as: :api_docs_spec, defaults: { format: :json }
  get "openapi.yaml", to: "documentation#spec", as: :openapi_spec, defaults: { format: :json }
